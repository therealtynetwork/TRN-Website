...
const tiles = [
  ...
  { img: img2, title: "Global Network", desc: "Vetted real estate professionals across 10+ countries. Send clients to Dubai, London, Miami, Malta, Greece and Cape Town. Receive inbound referrals in return." },
